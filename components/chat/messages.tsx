  ...
  return (
    <div className="relative flex-1 bg-background">
      ...
      <button
        ...
        className={`absolute bottom-4 left-1/2 z-10 flex min-h-11 min-w-11 -translate-x-1/2 items-center justify-center rounded-full border border-border/50 bg-card/90 px-3.5 shadow-[var(--shadow-float)] backdrop-blur-lg transition-all duration-200 text-[10px] ${
          isAtBottom
